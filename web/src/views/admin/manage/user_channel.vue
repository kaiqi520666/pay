<template>
  <el-scrollbar>
    <el-space>
      ...
      <el-button type="primary" icon="Search" @click="find_records"
        >查询</el-button
      >
    </el-space>
    <el-divider />
    <el-table :data="records" border stripe v-loading="loading">
      ...
      <el-table-column label="操作">
        <template #default="prop">
          <el-button type="primary" @click="update_record(prop.row)"
            >修改</el-button
          >
        </template>
      </el-table-column>
...
import { QueryModel, UserChannelModel } from "@/types";
